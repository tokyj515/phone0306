...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: 'LostReport', 
                description: 'LostReport을 관리하는 화면입니다.', 
                key: 'lostReports', 
                route: '/lostreports/lostReports',
                ImageUrl: '',
            },
            { 
                title: 'Insurance', 
            ...
            { 
                ...
                description: 'NotificationHistory을 관리하는 화면입니다.', 
                key: 'notificationHistories', 
            ...
            { 
                title: 'BlockDevice', 
                description: 'BlockDevice을 관리하는 화면입니다.', 
                key: 'blockDevices', 
                route: '/mobiles/blockDevices',
                ImageUrl: '',
            },
            { 
                title: 'RestrictNetwork', 
