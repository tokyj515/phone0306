...
pluralCaseList.push( {plural: "lostreports/lostReports", pascal: "LostreportLostReport"} )

pluralCaseList.push( {plural: "insurances/insurances", pascal: "InsuranceInsurance"} )

pluralCaseList.push( {plural: "notifications/notificationHistories", pascal: "NotificationNotificationHistory"} )

pluralCaseList.push( {plural: "mobiles/blockDevices", pascal: "MobileBlockDevice"} )
pluralCaseList.push( {plural: "mobiles/restrictNetworks", pascal: "MobileRestrictNetwork"} )
